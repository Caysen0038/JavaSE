...
import im.view.module.em.function.CourseEMFactory;

public class CourseEM extends EM{
	/**
	...
	private void loadTab(){
		...
		tab.add(Img.getImg("sources/img/course.png", 0, 0, tab.getWidth(), tab.getHeight()));
		loadFunction();
	}
	...
	private void loadFunction(){
		...
		for(int i=0;i<count;i++){
			 ...
			 * 通过静态工厂获得功能实例
			 */
			function[i]=CourseEMFactory.getFunction(i,this);
