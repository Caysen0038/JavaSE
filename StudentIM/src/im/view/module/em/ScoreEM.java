...
import im.view.module.em.function.ScoreEMFactory;

public class ScoreEM extends EM{
	/**
	...
	private void loadTab(){
		...
		tab.add(Img.getImg("sources/img/score.jpg", 0, 0, tab.getWidth(), tab.getHeight()));
		loadFunction();
	}
	...
	private void loadFunction(){
		...
		for(int i=0;i<count;i++){
			 ...
			 * 通过静态工厂获得功能实例
			 */
			function[i]=ScoreEMFactory.getFunction(i,this);
