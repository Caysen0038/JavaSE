...
public class StudentEdit extends IMButton{
	/**
	 * 查询学生
	 */
	...
	private static StudentEdit function=new StudentEdit();
	...
	public void init(){
		...
		this.add(Img.getImg("sources/img/studentEdit.png", 0
		...
		private void loadEvent(){
			...
			button.addMouseListener(new MouseAdapter(){
				...
				public void mouseClicked(MouseEvent e){
					...
					if(isNum){
						record=QueryStudent.getQuery().queryById(input.getText());
					}else{
						return;
					}
					loadTable();
