...
public class AdminInsert extends IMButton{
	/**
	 * 
	 */
	...
	private static AdminInsert function=new AdminInsert();
	...
	public void init(){
		...
		this.add(Img.getImg("sources/img/adminInsert.png", 0, 0,EM.ICON_WIDTH, EM.ICON_HEIGHT));
	...
	private void setRecord(){
		List<String> info=Config.getDOM().getField("admin");
		Map<String,String> mean=Config.getDOM().getFieldName("admin");
