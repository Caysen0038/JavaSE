...
import im.view.module.em.function.StudentEMFactory;

public class StudentEM extends EM{
	/**
	...
	private void loadTab(){
		...
		tab.setType(this.getType());
		tab.add(Img.getImg("sources/img/student.jpg", 0, 0, tab.getWidth(), tab.getHeight()));
		loadFunction();
	}
	...
	private void loadFunction(){
		...
		for(int i=0;i<count;i++){
			 ...
			 * 通过静态工厂获得功能实例
			 */
			function[i]=StudentEMFactory.getFunction(i,this);
